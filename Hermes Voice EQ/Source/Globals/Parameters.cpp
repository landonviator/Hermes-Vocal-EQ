...
{
    _params.push_back({ViatorParameters::band1ID, ViatorParameters::band1Name, 20.0f, 80.0f, 20.0f, 0.3f});
    ...
    _params.push_back({ViatorParameters::band5ID, ViatorParameters::band5Name, -15.0f, 15.0f, 0.0f, 0.6f});
    _params.push_back({ViatorParameters::band6ID, ViatorParameters::band6Name, 5000, 20000, 20000, 0.6f});
}
